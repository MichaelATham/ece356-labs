...
#Init the tree
clf = DecisionTreeClassifier(max_depth=6, min_samples_leaf=21, class_weight={0: 1, 1: 1.25})
...
plot_tree(clf, filled=True, feature_names=X.columns, class_names=['Not Inducted', 'Inducted'], rounded=True, fontsize=8)

plt.savefig('taskBTree.svg', format='svg', dpi=600)
